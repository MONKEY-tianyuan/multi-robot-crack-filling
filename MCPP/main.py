...
def main():
    ...
    def evaluate(ga, chromosome, individual_id):
        ...
        for h in decoding:
            ...
            # for tour in router.tours:
            #     print('tour',tour.vertexSequence)
            #print(router.heuristics[h](h))
        ...
        if ga.best_fitness < fitness:
            ...
            for tour in router.tours:
                print('tour_vertex:',tour.vertexSequence)
            for tour in router.tours:
                print('tour_edge:',tour.edgeSequence)
    ...
    # create the metaga
    metaga = MetaGA(gene_len, chrom_len, evaluate)
